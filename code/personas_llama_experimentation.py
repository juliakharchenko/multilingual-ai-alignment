...
output_personas_individualistic_vs_collectivist_csv = "output_llama_personas_individualistic_collectivist.csv"

# Long term vs short term orientation
personas_orientation_df = pd.read_csv("../data/output_personas_long_term_orientation.csv")
output_personas_orientation_csv = "output_llama_personas_orientation.csv"

# Masculinity vs femininity
personas_mas_df = pd.read_csv("../data/output_personas_masculinity_femininity.csv")
output_personas_mas_csv = "output_llama_personas_mas_new.csv"

# Power distance index
personas_power_distance_df = pd.read_csv("../data/output_personas_power_distance_index.csv")
output_personas_power_distance_csv = "output_llama_personas_power_distance.csv"

# Uncertainty avoidance
personas_uncertainty_avoidance_df = pd.read_csv("../data/output_personas_uncertainty.csv")
output_personas_uncertainity_avoidance_csv = "output_llama_personas_uncertainty.csv"
